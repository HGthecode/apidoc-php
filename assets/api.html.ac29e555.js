...
<span class="token punctuation">{</span> 
   <span class="token doc-comment comment">/**
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4);function sn(an,tn){const a=p("ExternalLinkIcon");return i(),l("div",null,[d,n("table",null,[u,n("tbody",null,[r,k,v,m,q,b,h,g,f,y,_,A,w,E,T,n("tr",null,[P,n("td",null,[s("具体查看 "),n("a",N,[s("功能使用-调试时的事件"),t(a)])]),x,M]),n("tr",null,[L,n("td",null,[s("具体查看 "),n("a",R,[s("功能使用-调试时的事件"),t(a)])]),U,D])])]),F,O,n("table",null,[C,n("tbody",null,[I,Q,H,S,B,j,G,X,n("tr",null,[$,n("td",null,[s("接口调试时自动生成该字段的值，支持的参数值请查看"),n("a",V,[s("mock语法"),t(a)])]),z]),Y,K,W,J,Z])]),nn])}const ln=o(c,[["render",sn],["__file","api.html.vue"]]);export{ln as default};
