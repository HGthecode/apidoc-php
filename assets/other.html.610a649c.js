import{D as o}from"./DownloadFe.3ef8c1b3.js";import{f as i,o as c,c as l,e as n,w as u,b as a,d as s,a as r,r as e,u as d}from"./app.41fc9acb.js";import{_ as k}from"./_plugin-vue_export-helper.cdc0426e.js";const v=r(`<h1 id="webman-其它框架安装" tabindex="-1"><a class="header-anchor" href="#webman-其它框架安装" aria-hidden="true">#</a> Webman/其它框架安装</h1><div class="custom-container tip"><p class="custom-container-title">其它框架兼容</p><p>理论上Apidoc可通过手动配置来兼容任何基于composer的框架，此处以Webman框架为例来手动适配兼容</p></div><h2 id="_1、安装插件" tabindex="-1"><a class="header-anchor" href="#_1、安装插件" aria-hidden="true">#</a> 1、安装插件</h2><p>进入项目根目录，执行如下命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>composer require hg/apidoc
...
<span class="token keyword">return</span> <span class="token punctuation">[</span>
    ...
    <span class="token string single-quoted-string">&#39;apidoc&#39;</span> <span class="token operator">=&gt;</span> <span class="token punctuation">[</span>
        ...
        <span class="token comment">// （选配）代码生成器配置 注意：是一个二维数组</span>
...
<span class="token keyword">return</span> <span class="token punctuation">[</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">]</span><span class="token punctuation">;</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、添加前端页面" tabindex="-1"><a class="header-anchor" href="#_4、添加前端页面" aria-hidden="true">#</a> 4、添加前端页面</h2>`,19),m=a("p",null,"下载完成后解压，将apidoc文件夹拷贝到你的项目 public 目录下",-1),g={href:"http://xn--6qqv7i2xdt95b/apidoc/index.html",target:"_blank",rel:"noopener noreferrer"},b=i({__name:"other.html",setup(q){return(h,f)=>{const t=e("ClientOnly"),p=e("ExternalLinkIcon");return c(),l("div",null,[v,n(t,null,{default:u(()=>[n(d(o))]),_:1}),m,a("p",null,[s("打开浏览器访问 "),a("a",g,[s("http://你的域名/apidoc/index.html"),n(p)]),s(" ，出现接口文档页面，表示安装成功。")])])}}}),_=k(b,[["__file","other.html.vue"]]);export{_ as default};
