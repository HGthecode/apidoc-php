import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as p,b as n,d as s,e as o,h as c,a,r as l}from"./app.505796a2.js";const d="/apidoc-php/images/error-400.png",r={},u=n("h1",{id:"_404错误",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_404错误","aria-hidden":"true"},"#"),s(" 404错误")],-1),v=n("h2",{id:"页面不存在",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#页面不存在","aria-hidden":"true"},"#"),s(" 页面不存在")],-1),m=n("p",null,"访问Apidoc页面，无法正常显示apidoc前端页面，报出404页面不存在",-1),k=n("p",null,"解决方案：",-1),h=n("p",null,"1、检查apidoc前端文件是否放在正确的位置（通常在public目录下），以及前端文件夹命名是否正确（默认为apidoc）。",-1),b={href:"/help/courses/hyperf-install.html#_3%E3%80%81%E9%85%8D%E7%BD%AEhyperf%E9%9D%99%E6%80%81%E8%B5%84%E6%BA%90%E8%AE%BF%E9%97%AE",target:"_blank",rel:"noopener noreferrer"},g=a('<h2 id="页面提示错误" tabindex="-1"><a class="header-anchor" href="#页面提示错误" aria-hidden="true">#</a> 页面提示错误</h2><p><img src="'+d+`" alt="error-400"></p><blockquote><p>访问apidoc页面时，以下几个原因有可能导致页面显示 404 错误</p></blockquote><p>通常该问题会报出 <code>Request failed with status code 404</code> 或<code>Cannot read property &#39;config&#39; of undefined</code> 或<code>当前访问路由未定义或不匹配</code>等错误。</p><p>这并不是文件不存在，而是apidoc会自动注册一些所需的路由，由于某种原因导致未注册成功</p><h3 id="_1、伪静态配置" tabindex="-1"><a class="header-anchor" href="#_1、伪静态配置" aria-hidden="true">#</a> 1、伪静态配置</h3><p><code>Tp5.1</code>、<code>Tp6</code>、<code>Laravel</code>通过Nginx/Apache代理的网站，如果没有正确配置项目伪静态规则，可能会导致无法正常访问路由</p><h4 id="解决方案1-配置伪静态规则" tabindex="-1"><a class="header-anchor" href="#解决方案1-配置伪静态规则" aria-hidden="true">#</a> 解决方案1：配置伪静态规则</h4><blockquote><p>以下为Tp6的伪静态规则，其它框架请自行到官网查看</p></blockquote><ul><li>Apache</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;IfModule mod_rewrite.c&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function f(x,E){const e=l("ExternalLinkIcon");return i(),p("div",null,[u,v,m,k,h,n("p",null,[s("2、检查运行环境或框架是否关闭了静态资源的访问，如Hyperf需要手动开启静态资源访问的（"),n("a",b,[s("配置Hyperf静态资源访问"),o(e)]),s("）。")]),g,c(` ### 2、 手动注册路由
...
其它手动兼容的框架需手动注册Apidoc所需路由，具体请参考相关框架的安装文档。 `),_])}const T=t(r,[["render",f],["__file","404.html.vue"]]);export{T as default};
