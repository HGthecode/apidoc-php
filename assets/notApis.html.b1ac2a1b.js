import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,a as e}from"./app.8b8f046f.js";const p={},t=e(`<h1 id="没有解析出接口文档" tabindex="-1"><a class="header-anchor" href="#没有解析出接口文档" aria-hidden="true">#</a> 没有解析出接口文档</h1><p>正常安装好Apidoc后，发现页面的接口列表没有任何接口列出；可检查以下几个可能。</p><h2 id="_1、apps的path没有配置正确" tabindex="-1"><a class="header-anchor" href="#_1、apps的path没有配置正确" aria-hidden="true">#</a> 1、apps的path没有配置正确</h2><p>检查 apidoc.php 配置文件的 apps 中的path是否配置正确，如下</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
