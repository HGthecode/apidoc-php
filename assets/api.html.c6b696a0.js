import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c,b as n,d as s,e as t,w as e,a as o,r as d}from"./app.fe05e39b.js";const l={},u=o(`<h1 id="接口注释" tabindex="-1"><a class="header-anchor" href="#接口注释" aria-hidden="true">#</a> 接口注释</h1><p>控制器中的每一个符合注释规则的方法都会被解析成一个API接口</p><h2 id="基础注释" tabindex="-1"><a class="header-anchor" href="#基础注释" aria-hidden="true">#</a> 基础注释</h2><p>先来体验一个最基本的注释，所得到的结果</p><p>我们在控制器中加入如下方法，如下</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
