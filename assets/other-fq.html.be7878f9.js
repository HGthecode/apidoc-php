import{D as i}from"./DownloadFe.0945dc11.js";import{g as c,o as l,c as u,e as n,w as r,b as a,d as s,a as t,r as e,u as d}from"./app.21b7d189.js";import{_ as k}from"./_plugin-vue_export-helper.cdc0426e.js";const v=t(`<h1 id="webman-其它框架安装" tabindex="-1"><a class="header-anchor" href="#webman-其它框架安装" aria-hidden="true">#</a> Webman/其它框架安装</h1><div class="custom-container tip"><p class="custom-container-title">其它框架兼容</p><p>理论上Apidoc可通过手动配置来兼容任何基于composer的框架，此处以Webman框架为例来手动适配兼容</p></div><h2 id="_1、安装插件" tabindex="-1"><a class="header-anchor" href="#_1、安装插件" aria-hidden="true">#</a> 1、安装插件</h2><p>进入项目根目录，执行如下命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>composer require hg/apidoc
