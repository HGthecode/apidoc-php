import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,a as e}from"./app.d99eb2d6.js";const p={},t=e(`<h1 id="引入apidoc注解" tabindex="-1"><a class="header-anchor" href="#引入apidoc注解" aria-hidden="true">#</a> 引入Apidoc注解</h1><p>在写Apidoc注解类中，必须<code>use</code>引入Apidoc注解类，否则会出现<code>[Semantical Error] The annotation...</code>的报错</p><h2 id="引入方式一-推荐" tabindex="-1"><a class="header-anchor" href="#引入方式一-推荐" aria-hidden="true">#</a> 引入方式一（推荐）</h2><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
