...
<span class="token punctuation">{</span> 
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参数说明" tabindex="-1"><a class="header-anchor" href="#参数说明" aria-hidden="true">#</a> 参数说明</h2><div class="custom-container warning"><p class="custom-container-title">注意</p><ul><li>每个参数以 @+参数名(&quot;参数值&quot;,子参数名=&quot;子参数值&quot;,...)</li><li>参数名首字母大写，避免有些环境不能正确解析小写首字母</li><li>子参数的值需用&quot;双引号&quot;包起来</li></ul></div>`,47),u=n("thead",null,[n("tr",null,[n("th",null,"参数名"),n("th",null,"参数值"),n("th",null,"说明"),n("th",null,"书写规范")])],-1),r=n("tr",null,[n("td",null,"Title"),n("td"),n("td",null,"接口名称"),n("td",null,[s("任意字符，也可如以下"),n("a",{href:"#%E7%89%B9%E6%AE%8A%E5%8F%82%E6%95%B0"},"特殊参数"),s("直接写在注释前面")])],-1),k=n("tr",null,[n("td",null,"Desc"),n("td"),n("td",null,"接口描述"),n("td",null,"任意字符")],-1),v=n("tr",null,[n("td",null,"Md"),n("td"),n("td",null,[s("Markdown描述，子参数"),n("code",null,"ref"),s("引用一个md文件内容")]),n("td",null,"Markdown语法字符")],-1),m=n("tr",null,[n("td",null,"Author"),n("td"),n("td",null,"作者"),n("td",null,[s("任意字符,默认配置文件的"),n("code",null,"apidoc.default_author")])],-1),q=n("tr",null,[n("td",null,"Url"),n("td"),n("td",null,"真实的接口URL，不配置时会根据控制器目录自动生成"),n("td",null,"任意字符")],-1),b=n("tr",null,[n("td",null,"Method"),n("td"),n("td",null,[s("请求类型,默认配置文件的"),n("code",null,"apidoc.default_method"),s(",多个类型(用,隔开)")]),n("td",null,[n("code",null,"GET"),s(),n("code",null,"POST"),s("等")])],-1),h=n("tr",null,[n("td",null,"RouteMiddleware"),n("td"),n("td",null,"开启自动注册路由时，定义路由中间件"),n("td")],-1),g=n("tr",null,[n("td",null,"ContentType"),n("td"),n("td",null,"指定调试时请求ContentType"),n("td")],-1),f=n("tr",null,[n("td",null,"Tag"),n("td"),n("td",null,"接口Tag标签"),n("td",null,"多个标签用,（逗号）空格隔开")],-1),y=n("tr",null,[n("td",null,"Header"),n("td",null,[s("具体查看 "),n("a",{href:"#%E6%8E%A5%E5%8F%A3%E5%8F%82%E6%95%B0"},"接口参数")]),n("td",null,"请求Headers参数"),n("td",null,"可定义多个")],-1),_=n("tr",null,[n("td",null,"Query"),n("td",null,[s("具体查看 "),n("a",{href:"#%E6%8E%A5%E5%8F%A3%E5%8F%82%E6%95%B0"},"接口参数")]),n("td",null,"请求Query参数"),n("td",null,"可定义多个")],-1),A=n("tr",null,[n("td",null,"Param"),n("td",null,[s("具体查看 "),n("a",{href:"#%E6%8E%A5%E5%8F%A3%E5%8F%82%E6%95%B0"},"接口参数")]),n("td",null,"请求Body参数"),n("td",null,"可定义多个")],-1),w=n("tr",null,[n("td",null,"ParamType"),n("td",null,[n("code",null,"json"),s(),n("code",null,"formdata")]),n("td",null,"请求参数类型，默认json"),n("td")],-1),E=n("tr",null,[n("td",null,"Returned"),n("td",null,[s("具体查看 "),n("a",{href:"#%E6%8E%A5%E5%8F%A3%E5%8F%82%E6%95%B0"},"接口参数")]),n("td",null,"响应结果"),n("td",null,"可定义多个")],-1),T=n("tr",null,[n("td",null,"ResponseSuccess"),n("td",null,"当前接口的成功响应体，通过main=true指定业务数据挂载节点"),n("td",null,[s("如："),n("div",null,'@Apidoc\\ResponseSuccess("code",type="int",desc="业务编码")'),n("div",null,'@Apidoc\\ResponseSuccess("data",type="object",desc="业务数据",main=true)')]),n("td")],-1),P=n("tr",null,[n("td",null,"ResponseError"),n("td",null,"当前接口的异常响应体"),n("td",null,"同上"),n("td")],-1),N=n("tr",null,[n("td",null,"ResponseSuccessMd"),n("td",null,"使用Markdown写成功响应体"),n("td",null,"支持ref引入md文件"),n("td")],-1),x=n("tr",null,[n("td",null,"ResponseError"),n("td",null,"使用Markdown写异常响应体"),n("td",null,"同上"),n("td")],-1),M=n("td",null,"Before",-1),R={href:"/use/function/debugEvent/",target:"_blank",rel:"noopener noreferrer"},L=n("td",null,"调试时请求发起前执行的事件",-1),U=n("td",null,"可定义多个",-1),D=n("td",null,"After",-1),F={href:"/use/function/debugEvent/",target:"_blank",rel:"noopener noreferrer"},O=n("td",null,"调试时请求返回后执行的事件",-1),C=n("td",null,"可定义多个",-1),I=n("h3",{id:"接口参数",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#接口参数","aria-hidden":"true"},"#"),s(" 接口参数")],-1),Q=n("p",null,[s("适用于接口"),n("code",null,"Header"),s(","),n("code",null,"Query"),s(","),n("code",null,"Param"),s(","),n("code",null,"Returned"),s("注解")],-1),S=n("thead",null,[n("tr",null,[n("th",null,"参数名"),n("th",null,"说明"),n("th",null,"书写规范")])],-1),H=n("tr",null,[n("td"),n("td",null,"参数的字段名"),n("td",null,'如：@Apidoc\\Param("name")，如使用ref引入某个定义，可不配置参数值')],-1),B=n("tr",null,[n("td",null,"type"),n("td",null,"字段类型"),n("td",null,[n("code",null,"string"),s(),n("code",null,"int"),s(),n("code",null,"boolean"),s(),n("code",null,"array"),s(),n("code",null,"object"),s(),n("code",null,"tree"),s(),n("code",null,"file"),s(),n("code",null,"float"),s(),n("code",null,"date"),s(),n("code",null,"time"),s(),n("code",null,"datetime")])],-1),j=n("tr",null,[n("td",null,"require"),n("td",null,"是否必填"),n("td")],-1),G=n("tr",null,[n("td",null,"default"),n("td",null,"默认值"),n("td")],-1),X=n("tr",null,[n("td",null,"desc"),n("td",null,"字段描述"),n("td")],-1),$=n("tr",null,[n("td",null,"md"),n("td",null,"引用Markdown描述内容"),n("td")],-1),V=n("tr",null,[n("td",null,"mdRef"),n("td",null,"引用Markdown描述内容"),n("td",null,[s("如："),n("code",null,"/docs/xxx.md")])],-1),z=n("tr",null,[n("td",null,"ref"),n("td",null,"引入定义的路径，可引入全局定义、服务层方法类、模型方法"),n("td",null,[n("div",null,'如：@Apidoc\\Param(ref="pagingParam")'),n("div",null,'或：@Apidoc\\Param(ref="app\\services\\ApiDocTest\\get")'),n("div",null,'或：@Apidoc\\Param(ref="app\\model\\User\\getList")')])],-1),Y=n("td",null,"mock",-1),K={href:"/use/function/mock",target:"_blank",rel:"noopener noreferrer"},W=n("td",null,null,-1),J=n("tr",null,[n("td",null,"field"),n("td",null,"配置了ref引入时有效，用来指定引入的字段"),n("td",null,'如：field="id,username"；则只会引入定义的 id,username字段')],-1),Z=n("tr",null,[n("td",null,"withoutField"),n("td",null,"配置了ref引入时有效，用来指定过滤掉的字段"),n("td",null,"如：withoutField:id,username；则引入模型除 id,username字段外的所有字段")],-1),nn=n("tr",null,[n("td",null,"childrenField"),n("td",null,[s("字段类型为"),n("code",null,"tree"),s("时，给其定义子节点字段名")]),n("td",null,"默认为 children")],-1),sn=n("tr",null,[n("td",null,"childrenDesc"),n("td",null,[s("字段类型为"),n("code",null,"tree"),s("时，给其定义子节点字段名的备注")]),n("td")],-1),an=n("tr",null,[n("td",null,"childrenType"),n("td",null,[s("字段类型为"),n("code",null,"array"),s("时，为子参数定义类型，可选值有"),n("code",null,"string"),s(),n("code",null,"int"),s(),n("code",null,"boolean"),s(),n("code",null,"array"),s(),n("code",null,"object")]),n("td")],-1),tn=e(`<h2 id="特殊参数" tabindex="-1"><a class="header-anchor" href="#特殊参数" aria-hidden="true">#</a> 特殊参数</h2><div class="custom-container tip"><p class="custom-container-title">说明</p><p>特殊参数以字符方式直接写到注释中，如下</p></div><table><thead><tr><th>参数名</th><th>说明</th></tr></thead><tbody><tr><td>NotParse</td><td>不需要解析的方法</td></tr><tr><td>NotHeaders</td><td>不使用配置中的全局请求Headers参数</td></tr><tr><td>NotQuerys</td><td>不使用配置中的全局请求Querys参数</td></tr><tr><td>NotParams</td><td>不使用配置中的全局请求Params参数</td></tr><tr><td>NotResponses</td><td>不使用统一响应体返回数据</td></tr><tr><td>NotResponseSuccess</td><td>不使用成功响应体返回数据</td></tr><tr><td>NotResponseError</td><td>不使用异常响应体返回数据</td></tr><tr><td>NotDefaultAuthor</td><td>不使用默认作者</td></tr><tr><td>NotDebug</td><td>关闭接口调试</td></tr></tbody></table><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
<span class="token keyword">namespace</span> <span class="token package">app<span class="token punctuation">\\</span>controller</span><span class="token punctuation">;</span>
<span class="token keyword">use</span> <span class="token package">hg<span class="token punctuation">\\</span>apidoc<span class="token punctuation">\\</span>annotation</span> <span class="token keyword">as</span> Apidoc<span class="token punctuation">;</span>
...
<span class="token punctuation">{</span> 
   <span class="token doc-comment comment">/**
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4);function en(on,ln){const a=p("ExternalLinkIcon");return i(),l("div",null,[d,n("table",null,[u,n("tbody",null,[r,k,v,m,q,b,h,g,f,y,_,A,w,E,T,P,N,x,n("tr",null,[M,n("td",null,[s("具体查看 "),n("a",R,[s("功能使用-调试时的事件"),t(a)])]),L,U]),n("tr",null,[D,n("td",null,[s("具体查看 "),n("a",F,[s("功能使用-调试时的事件"),t(a)])]),O,C])])]),I,Q,n("table",null,[S,n("tbody",null,[H,B,j,G,X,$,V,z,n("tr",null,[Y,n("td",null,[s("接口调试时自动生成该字段的值，支持的参数值请查看"),n("a",K,[s("mock语法"),t(a)])]),W]),J,Z,nn,sn,an])]),tn])}const dn=o(c,[["render",en],["__file","api.html.vue"]]);export{dn as default};
