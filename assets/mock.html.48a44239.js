import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as a,c as s,a as e}from"./app.f4bfd2d7.js";const i={},t=e(`<h1 id="mock调试数据" tabindex="-1"><a class="header-anchor" href="#mock调试数据" aria-hidden="true">#</a> Mock调试数据</h1><p>在接口调试时，往往需要填写大量的测试数据来进行请求测试；</p><p>有了Mock数据的功能，在调试时，自动根据规则生成调试数据，接口调试更高效。</p><h2 id="注解方式" tabindex="-1"><a class="header-anchor" href="#注解方式" aria-hidden="true">#</a> 注解方式</h2><p>只需要在接口注解的<code>Query</code>、<code>Param</code>中加入<code>mock</code>的配置即可</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token doc-comment comment">/**
 * mock调试数据
