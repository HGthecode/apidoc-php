import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as d,b as n,d as s,e as t,w as e,a as o,r as c}from"./app.7106b467.js";const l={},u=o(`<h1 id="接口注释" tabindex="-1"><a class="header-anchor" href="#接口注释" aria-hidden="true">#</a> 接口注释</h1><p>控制器中的每一个符合注释规则的方法都会被解析成一个API接口</p><h2 id="基础注释" tabindex="-1"><a class="header-anchor" href="#基础注释" aria-hidden="true">#</a> 基础注释</h2><p>先来体验一个最基本的注释，所得到的结果</p><p>我们在控制器中加入如下方法，如下</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token punctuation">{</span> 
   <span class="token doc-comment comment">/**
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function Q(I,S){const a=c("RouterLink");return p(),d("div",null,[u,n("table",null,[r,n("tbody",null,[k,v,m,q,b,h,g,y,f,A,w,_,E,T,P,N,M,x,n("tr",null,[R,n("td",null,[s("具体查看 "),t(a,{to:"/use/function/debugEvent/"},{default:e(()=>[s("功能使用-调试时的事件")]),_:1})]),L,U]),n("tr",null,[D,n("td",null,[s("具体查看 "),t(a,{to:"/use/function/debugEvent/"},{default:e(()=>[s("功能使用-调试时的事件")]),_:1})]),F,O])])]),C])}const j=i(l,[["render",Q],["__file","api.html.vue"]]);export{j as default};
