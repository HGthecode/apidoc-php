...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="注解错误" tabindex="-1"><a class="header-anchor" href="#注解错误" aria-hidden="true">#</a> 注解错误</h2><p>访问apidoc页面时，如出现如下错误信息；通常有具体的描述，根据描述信息排查即可</p><p><img src="`+i+'" alt="error-501"></p><h2 id="缺少注解解释文件" tabindex="-1"><a class="header-anchor" href="#缺少注解解释文件" aria-hidden="true">#</a> 缺少注解解释文件</h2><p>项目所有被解析文件的注释中存在 @XXX 的，都需<code>use</code>引入注释解释文件，如出现以下错误</p><p><img src="'+c+`" alt="error-500"></p><p>可根据提示在相应的文件里，加上use解释文件</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,25),u=[l];function d(r,k){return a(),e("div",null,u)}const b=s(o,[["render",d],["__file","500.html.vue"]]);export{b as default};
