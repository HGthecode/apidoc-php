import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,a as e}from"./app.7f78080c.js";const p="/images/error-501.png",t="/images/error-auth-1.png",i="/images/error-500.png",c={},o=e('<h1 id="页面报错" tabindex="-1"><a class="header-anchor" href="#页面报错" aria-hidden="true">#</a> 页面报错</h1><h2 id="注解错误" tabindex="-1"><a class="header-anchor" href="#注解错误" aria-hidden="true">#</a> 注解错误</h2><p>访问apidoc页面时，如出现如下错误信息；通常有具体的描述，根据描述信息排查即可</p><p><img src="'+p+'" alt="error-501"></p><h2 id="访问授权错误" tabindex="-1"><a class="header-anchor" href="#访问授权错误" aria-hidden="true">#</a> 访问授权错误</h2><p>当开启访问授权配置时，因框架的全局异常处理，没有将401状态码正常返回时出现</p><p>ThinkPHP在未对全局异常处理进行修改的，出现以下错误：</p><p><img src="'+t+`" alt="error-auth-1"></p><p>可参考以下异常处理类来处理</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token comment">// tp6为例</span>
